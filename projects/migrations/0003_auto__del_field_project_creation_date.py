...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'projects_project', 'creation_date')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Project.creation_date'
        raise RuntimeError("Cannot reverse this migration. 'Project.creation_date' and its values cannot be restored.")
