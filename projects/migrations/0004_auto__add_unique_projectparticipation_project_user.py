...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProjectParticipation', fields ['project', 'user']
        db.create_unique(u'projects_projectparticipation', ['project_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectParticipation', fields ['project', 'user']
        db.delete_unique(u'projects_projectparticipation', ['project_id', 'user_id'])
